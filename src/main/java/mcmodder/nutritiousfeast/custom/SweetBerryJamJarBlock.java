...
//Pretty much the only difference between HoneyJar and SweetBerryJamJar is that SweetBerryJamJar doesn't clear the Poison effect. Also, you can't eat sweet berry jam if you have full food bars. And also this comment
public class SweetBerryJamJarBlock extends JarBlock {
    public static final int MAX_TIMES_EATEN = 4;
    public static final IntProperty TIMES_EATEN = IntProperty.of("times_eaten", 0, 4);

    public SweetBerryJamJarBlock(Settings settings) {
        super(settings);
    }
