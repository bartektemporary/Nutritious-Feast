...
public class CookieJarBlock extends JarBlock {
    public static final int MAX_TIMES_EATEN = 7;
    public static final IntProperty TIMES_EATEN = IntProperty.of("times_eaten", 0, 7);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (!world.isClient) {
            world.playSound(null, pos, SoundEvents.ENTITY_STRIDER_EAT, SoundCategory.AMBIENT, 1f, 1f);
        }
